        ...
        <div className="container">
          ...
          <div className="flex h-[527px] mt-6 items-end flex-row-reverse">
            ...
            <div className="basis-full lg:basis-1/2 h-full flex justify-center items-center relative">
              ...
              <div
                className="w-[234px] h-[72px] gap-3 bg-white p-3 pl-5 rounded-3xl flex items-center absolute -left-20 top-20  hidden lg:flex"
                style={{ boxShadow: "0px 32px 64px -12px rgba(0, 0, 0, 0.14)" }}
              >
            ...
            <div className="basis-1/4 h-full relative hidden lg:flex">
              <div
                className="w-[239px] h-[72px] bg-white p-3 justify-between rounded-3xl flex items-center absolute -left-20 bottom-20"
                style={{ boxShadow: "0px 32px 64px -12px rgba(0, 0, 0, 0.14)" }}
              >
                <div className="w-12 h-12 rounded-[32px] bg-light-950 flex justify-center items-center ">
