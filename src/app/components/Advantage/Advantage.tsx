    ...
    <div className="bg-light-950">
      <div className="container">
        <section className="py-7.5rem items-center flex flex-col space-between ">
          ...
          <ol className="flex flex-row flex-wrap gap-2 justify-center w-2/3">
            <li className={`border border-white p-5 pl-8 rounded-[56px] flex justify-center items-center text-white gap-2 advantage-item`}>
